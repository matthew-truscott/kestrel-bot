...
ahead of time. Current information can be found under the SERVERWIDE category.
    ...
    async def softban(self, ctx, user: discord.Member, *, reason: str = None):
        ...
        try:
            invite = await self.bot.create_invite(channel, max_age=3600*24)
        except:
            invite = ""
    ...
    @commands.has_role("god")
    @mute.command(name="channelm", pass_context=True, no_pm=True)
    ...
    @commands.has_role("god")
    @mute.command(name="serverm", pass_context=True, no_pm=True)
    ...
    @commands.has_role("god")
    @mute.command(name="channelum", pass_context=True, no_pm=True)
    ...
    @commands.has_role("god")
    @mute.command(name="serverum", pass_context=True, no_pm=True)
